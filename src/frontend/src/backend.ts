...
export class Backend implements backendInterface {
    ...
    async getFileHistoryByType(arg0: FileEventType): Promise<Array<FileEvent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFileHistoryByType(to_candid_FileEventType_n27(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_DocumentMetadata_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DocumentMetadata): Promise<DocumentMetadata> {
...
function from_candid_FileEventType_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileEventType): FileEventType {
    return from_candid_variant_n26(_uploadFile, _downloadFile, value);
}
function from_candid_FileEvent_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FileEvent): FileEvent {
...
async function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [{
        blob: _ExternalBlob;
        mimeType: string;
        filename: string;
    }]): Promise<{
    ...
    return value.length === 0 ? null : await from_candid_record_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DocumentMetadata]): Promise<DocumentMetadata | null> {
    return value.length === 0 ? null : await from_candid_DocumentMetadata_n18(_uploadFile, _downloadFile, value[0]);
}
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [{
        blob: _ExternalBlob;
        mimeType: string;
    }]): Promise<{
    blob: ExternalBlob;
    ...
    return value.length === 0 ? null : await from_candid_record_n21(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        eventType: from_candid_FileEventType_n25(_uploadFile, _downloadFile, value.eventType)
    };
}
...
function to_candid_variant_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileEventType): {
    publicAccess: null;
} | {
    preview: null;
} | {
